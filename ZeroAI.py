...
def fetch_tag(input_text, mycursor):
    ...
    if len(markets) > 0:
        ...
        " inner join pricehistory on pricehistory.symbol = symbol_alias.symbol and pricehistory.date = '" + today_str + "' and pricehistory.c > 0 and pricehistory.l > 0 and pricehistory.predicttime is not null and pricehistory.h <> pricehistory.l" \
